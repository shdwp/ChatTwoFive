...
internal static class Fonts {
    ...
    internal static readonly Font[] GlobalFonts = {
        new(
            ...
            "ChatTwoFive.fonts.NotoSans-Regular.ttf",
            "ChatTwoFive.fonts.NotoSans-Italic.ttf"
        ),
        new(
            $"{IncludedIndicator}Noto Serif",
            "ChatTwoFive.fonts.NotoSerif-Regular.ttf",
            "ChatTwoFive.fonts.NotoSerif-Italic.ttf"
        ),
        new(
            $"{IncludedIndicator}Open Sans",
            "ChatTwoFive.fonts.OpenSans-Regular.ttf",
            "ChatTwoFive.fonts.OpenSans-Italic.ttf"
        ),
        new(
            $"{IncludedIndicator}Roboto",
            "ChatTwoFive.fonts.Roboto-Regular.ttf",
            "ChatTwoFive.fonts.Roboto-Italic.ttf"
        ),
    };

    internal static readonly (string, string)[] JapaneseFonts = {
        ($"{IncludedIndicator}Noto Sans JP", "ChatTwoFive.fonts.NotoSansJP-Regular.otf"),
        // ($"{IncludedIndicator}Noto Serif JP", "ChatTwoFive.fonts.NotoSerifJP-Regular.otf"),
    };
